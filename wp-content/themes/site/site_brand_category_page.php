<?php
	 ...
	 * permalink structure: category/category/[brand]/brandname.html
	 *
	 * @package WordPress
...
echo "<!-- site_brand_category_page.php /brand/category/category/brandname.html -->";
?>
...
if($DEEPCATEGORIES == '1')
{
$parts2 = explode( '.html', $parts1[4] ); 
}else{
$parts2 = explode( '.html', $parts1[2] );
}?>
<?php $parts5 = explode( '.', $parts1[3] ); ?>
<?php $parts6 = explode( '.', $parts1[4] ); ?>
<?php $parts7 = explode( '.', $parts1[3] ); ?>
...
$seo_title_temp = str_replace("[category_name]",str_replace('-',' ',$parts1[2]),$CATEGORYBRANDSUBCATTITLE);
$seo_description_temp = str_replace("[category_name]",str_replace('-',' ',$parts1[2]),$CATEGORYBRANDSUBCATDESCRIPTION);
$seo_keywords_temp = str_replace("[category_name]",str_replace('-',' ',$parts1[2]),$CATEGORYBRANDSUBCATKEYWORDS);
...
if($DEEPCATEGORIES == '1')
{
	site_review_product_brand_list_outdoor_brand_subcat(1);
}
else
{
...
<div id="content-left" class="col-sm-8">
	<div class="inner">			
		<div class="main-content">
			...
			{
				?>
					<h2><?php echo str_replace('-',' ',$parts1[2]); echo " - ".$parts6[0]; ?> - <?php echo str_replace("-"," ",$parts7[0]); ?></h2>			
					<p class="subheadertext">
						Select the <?Php echo ucfirst($parts6[0]); ?> product you are looking for or choose a different brand
					</p>
			...
			{
				?>
				<h2><?php echo str_replace('-',' ',$parts1[1]); echo " - ".$Brand->manufacturer_name; ?> <?php echo str_replace("_"," ",$parts5[0]); ?></h2>
				<?php
			}
			?>
...
<div class="golf-clubs">
	...
	<div style="clear:both;">
		<div class="golf-club-list"> Select the brand alphabetically 	
			...
			if($DEEPCATEGORIES=="1")
			{
				if(function_exists('site_review_brand_list_components_brand_category_two'))
				{ 
					site_review_brand_list_components_brand_category_two(1, "components", $BrandIdList); 
...
<?php
	...
	if($Products) { ?>
					...
					if($DEEPCATEGORIES == '1')
					{
						$pagination = "cr_brand_pagination_outdoor_brand_two";
					}
					else
					{
	...
	<div id="products" class="product-list">
		...
		<div style="float:right;"><?php $pagination($Brand, $_GET['pg']); ?></div>
			<?php 
				$i=0;
		...
		<div class="product-list-nav clearfix"><div style="float:right;"><?php $pagination($Brand,$_GET['pg']); ?></div>
			<?php //if($i > 50) { ?>
			<div style="float:right;">Showing <?php cr_product_count_showing($Brand,$_GET['pg']); ?> of <?php echo $Brand->product_count; ?> <!--<?php echo $Brand->manufacturer_name; ?> <?php cr_category_name($Brand->category_name); ?>-->&nbsp;</div>
			<?php //} ?>
	</div>
	<?php } else { //header("Location: /404");?><!-- end product list -->	
