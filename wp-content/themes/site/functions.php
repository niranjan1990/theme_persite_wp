...
add_filter( 'wpcf7_load_css', '__return_false' );
	...
	if ( function_exists('register_sidebar') )
	  register_sidebar(array(
	    'name' => 'Site Skin Ad 1680x800',
	    'before_widget' => '<div class = "SiteSkinArea">',
	    'after_widget' => '</div>',
	    'before_title' => '<h3>',
	    'after_title' => '</h3>',
	  )
	...
	if ( function_exists('register_sidebar') )
	  register_sidebar(array(
	    'name' => 'Interstitial Ad 1x1',
	    'before_widget' => '<div class = "InterstitialArea">',
	    'after_widget' => '</div>',
	    'before_title' => '<h3>',
	    'after_title' => '</h3>',
	  )
	...
	if ( function_exists('register_sidebar') )
	  register_sidebar(array(
	    'name' => 'Product listing Mobile Ad 300x250',
	...
	if ( function_exists('register_sidebar') )
	  register_sidebar(array(
	    'name' => 'Product listing Mobile Ad-1 300x250',
	    'before_widget' => '<div class = "widgetizedMobileArea">',
	    'after_widget' => '</div>',
	    'before_title' => '<h3>',
	    'after_title' => '</h3>',
	  )
	...
	if ( function_exists('register_sidebar') )
	  register_sidebar(array(
	    'name' => 'Footer Sticky Mobile Ad-2 300x50',
	    'before_widget' => '<div class = "widgetMobileArea">',
	    'after_widget' => '</div>',
	    'before_title' => '<h3>',
	    'after_title' => '</h3>',
	  )
	...
	if ( function_exists('register_sidebar') )
	  register_sidebar(array(
	    'name' => 'Header Mobile Ad 320x50',
	    'before_widget' => '<div class = "MobileHeadArea">',
	    'after_widget' => '</div>',
	    'before_title' => '<h3>',
	    'after_title' => '</h3>',
	  )
	...
	if ( function_exists('register_sidebar') )
	  register_sidebar(array(
	    'name' => 'Footer Mobile Ad 300x50',
	    'before_widget' => '<div class = "MobileFooterArea">',
	    'after_widget' => '</div>',
	    'before_title' => '<h3>',
	    'after_title' => '</h3>',
	  )
	...
	function my_setcookie_example($username_value,$username) {
		...
		$post = [];
		$ch = curl_init(VBULLETINURL.'/wp_bulletin_cookie_password.php?userid='.$username_value);
		...
		setcookie( "bb_userid", $username_value, time() + 31536000, '/', COOKIE_DOMAIN_NEW  );
		setcookie( "bb_username", $username, time() + 31536000, '/', COOKIE_DOMAIN_NEW  );
		setcookie( "bb_password", $response, time() + 31536000, '/', COOKIE_DOMAIN_NEW  );
	...
	function my_setcookie_example1($username_value,$username) {
		$path = parse_url(get_option('siteurl'), PHP_URL_PATH);
		$host = parse_url(get_option('siteurl'), PHP_URL_HOST);
 ...
 */
	...
	function site_review_widgets_init() {
		...
		// Area Top, located below the main TOP Primary Widget Area in the sidebar. Empty by default.
		// 300x100 sidebar site wide

		register_sidebar( array(

			'name' => __( 'Sidebar 300x100 Widget', 'sitereview' ),
			'id' => 'secondary-sidebar-300x100widget-area',
			'description' => __( 'Secondary sidebar 300x100 area', 'sitereview' ),
		...
		register_sidebar( array(
			...
			'name' => __( '3: Sidebar TopWidget Area', 'sitereview' ),
			'id' => 'secondary-sidebar-topwidget-area',
			'description' => __( 'Secondary sidebar topwidget area', 'sitereview' ),
			'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
			'after_widget' => '</li>',
			'before_title' => '<h3 class="widget-title">',
			'after_title' => '</h3>',
		...
		//Area 13,ROS Sidebar ADS

		register_sidebar( array(

			'name' => __( '3: Sidebar TopWidget Area ROS', 'sitereview' ),
			'id' => 'secondary-sidebar-topwidget-area-ros',
			'description' => __( 'Secondary sidebar topwidget area', 'sitereview' ),
			'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
			'after_widget' => '</li>',
			'before_title' => '<h3 class="widget-title">',
		...
		// Area 14, located at the top of the sidebar ROS.
		register_sidebar( array(

			'name' => __( '1: Sidebar Widget Area ROS', 'sitereview' ),
			'id' => 'sidebar-widget-area-ros',
			'description' => __( 'The primary sidebar widget area', 'sitereview' ),
			'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
			'after_widget' => '</li>',
			'before_title' => '<h3 class="widget-title">',
		...
		// Area 12, ROS TOP LEADERBOARD.

		register_sidebar( array(

			'name' => __( 'Top Leaderboard 728x90 ROS', 'sitereview' ),
			'id' => 'top-leaderboard-ros-widget-area',
			'description' => __( 'Top Leaderboard 728x90 ROS', 'sitereview' ),
			'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
			'after_widget' => '</li>',
			'before_title' => '<h3 class="widget-title">',
			'after_title' => '</h3>',
		...
		register_sidebar( array(
			...
			'name' => __( 'Bottom Leaderboard 728x90 ROS', 'sitereview' ),
			'id' => 'bottom-leaderboard-widget-area-ros',
			'description' => __( 'Bottom leaderboard 728x90 ROS', 'sitereview' ),
			'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
			'after_widget' => '</li>',
			'before_title' => '<h3 class="widget-title">',
			'after_title' => '</h3>',
...
remove_action('wp_head', 'wp_seo_header_reader');
