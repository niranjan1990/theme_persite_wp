<?php /* Template Name: Site Top Reviews Page */ ?>
<?php
	/**
...
<?php	
	...
	$topreviewcount=get_option('topreviewscount');
	site_top_rated_product_list($topreviewcount);
...
<div id="content-left" class="col-sm-8">
	<div class="inner">			
		<div class="main-content">
			<h2><?php echo get_option('topreviews'); ?></h2>
...
<?php
	...
	?>
			<tbody style="border: 1px solid black;display: inherit;">  	        
				...
				<li class="product_views"><?php echo $Product->Views; ?> Views</li>
						<!--<li class="product_reviews"><a href="<?php echo $purl; ?>"><?php echo $view->Total_Reviews; ?> Reviews</a></li>-->
						<li class="product_rating"><?php $ratePerc = ($Product->Average_Rating/5)*100 ?>
