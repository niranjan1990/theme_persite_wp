<?php
	 ...
	 * permalink structure: /[category]/[category]/[category]/[category]/brand/brandname.html
	 *
	 * @package WordPress
...
session_start();
	...
	echo "<!-- site_brand_category_sub_page_four.php   /brand/[category]/[category]/[category]/category/brandname.html -->";
?>
...
if($DEEPCATEGORIES == '1')
{
 $parts2 = explode( '.html', $parts1[6] ); 
}else{
$parts2 = explode( '.html', $parts1[2] );
} ?>
<?php $parts4 = explode( '.', $parts1[3] ); ?>
<?php $parts5 = explode( '-brand.', $parts1[5] ); ?>
...
$seo_title_temp = str_replace("[category_name]",str_replace('-',' ',$parts1[1]),$BRANDSTITLEFOURLEVEL);
$seo_description_temp = str_replace("[category_name]",str_replace('-',' ',$parts1[1]),$BRANDSDESCRIPTIONFOURLEVEL);
$seo_keywords_temp = str_replace("[category_name]",str_replace('-',' ',$parts1[1]),$BRANDSKEYWORDSFOURLEVEL);
...
if($DEEPCATEGORIES == '1' )
{
	site_review_product_brand_list_outdoor_brand_subcat_four(1);
}
else
{
...
<div class="golf-clubs">
	...
	<div style="clear:both;">
		<div class="golf-club-list"> Select the brand alphabetically 	
			...
			if($DEEPCATEGORIES=="1")
			{
				if(function_exists('site_review_brand_list_components_brand_category_four'))
				{ 
					site_review_brand_list_components_brand_category_four(1, "components", $BrandIdList); 
