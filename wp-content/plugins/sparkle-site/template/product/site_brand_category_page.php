<?php
	 ...
	 * permalink structure: /[brand]/[category].html
	 *
	 * @package WordPress
...
<div id="content-left" class="col-sm-8">
	<div class="inner">			
		<div class="main-content">
			<h2><?php echo $Brand->manufacturer_name; ?> - <?php echo str_replace("_"," ",$Brand->category_name); ?></h2>
...
<?php
	...
	<div id="products" class="product-list">
		<div class="product-list-nav clearfix"><div style="float:right;"><?php cr_brand_cat_pagination($Brand, $_GET['page']); ?></div>
			<div style="float:right;">Showing <?php cr_product_count_showing($Brand,$_GET['page']); ?> of <?php echo $Brand->product_count; ?> <!--<?php echo $Brand->manufacturer_name; ?> <?php cr_category_name($Brand->category_name); ?>-->&nbsp;</div>
		</div>		
		...
		<?php foreach($Products as $Product) { ?>
			<tbody style="border: 1px solid black;">  	        
				...
				<li><a href="<?php cr_product_url($Product); ?>#reviews"><?php echo $Product->total_rating_count; ?> Reviews</a></li>
		...
		<tr class='clickable-row' align="center" data-href="<?php cr_product_url($Product); ?>">
			...
			<td><ul class="list-unstyled">
			<li style="font-size: 15px;font-weight: bold;"><?php echo $Product->product_name; ?>&nbsp;<?php echo $Product->manufacturer_name; ?></li>
			</ul></td><td><ul class="list-unstyled"><li><a href="<?php cr_product_url($Product); ?>#reviews"><?php echo $Product->total_rating_count; ?> Reviews</a></li>
			<li><?php echo $Product->total_rating; ?> of 5</li>
			<li><img src="<?php echo cr_rating_image($Product->total_rating); ?>" /></li>
			</ul></td></tr>
		</tbody>
	...
	<div class="related-articles"><?php
		$term_cat[] = $Brand->manufacturer_name;
		$term_cat[] = $Brand->category_name;		
		site_review_recent_articles('Recent Articles & Reviews on '.$Brand->manufacturer_name.' or '.$Brand->category_name,$term_cat,5); ?>
	</div>
