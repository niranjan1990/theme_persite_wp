...
width: 69px!important;
			...
			<div class="product-overview-mobile" id="product-overview-mobile" style="display:none;">
			     <div class="rightscore" style="float:left;margin-top: 15px;margin-left: 18px;">
                     ...
                     <div class="product-share meta clearfix" style="width:100%;height: 32px;">
                        <div class="pp" style="width:82px;float:left;margin-left:0px !important;">Do you like this product?</div>
                        ...
                        <div class="sbg" style="width:69px;float:left;    margin-left: -10px;"><a href="http://twitter.com/share" class="twitter-share-button" data-url="<?php cr_product_url($Product); ?>" data-count="horizontal">Tweet</a>
                            <script type="text/javascript" src="http://platform.twitter.com/widgets.js"></script>
                        </div>
                        <div class="sbg l" style="width:69px;float:left">
							<div class="g-plusone" data-size="standard" data-width="100" data-count="true" data-href="<?php cr_product_url($Product); ?>">
							</div>
						</div>
                    </div>
					...
					<td colspan="2" style="width:100%;">						
						...
						<?php for($i=0;$i<count($Product->media);$i++) { ?>							
							<li style='height:150px !important;'>
								<p align="center">
									<img class="img-responsive center-block" id="thumb-img-<?php echo $i; ?>" src="<?php echo cr_product_image($Product->media[$i]->value,'150x150'); ?>" width="150" height="150" />
								</p>
							</li>
						<?php }?></ul>
						<?php } else { ?>
							<div id="innerproductimage" style=''><p align="center">
							<img id="thumb-img-0" class="img-responsive center-block" src="<?php echo cr_product_image($Product->product_image, 'product'); ?>" width="150" height="150" /></p></div>
						<?php } ?>		
					</td>	
				</tr>
                <tr>
    ...
    padding-top: 5px;"><?php  if($_COOKIE['username'] && $count>0){ echo $res1['overall_rating'];}else { echo "?";} ?>/5</p></div></center>
                    ...
                    <tr><td colspan="2"><center><?php  
											...
											{ 
												...
												echo "<div style='' ><p><a style='    font-weight: normal;    text-decoration: none;    padding: 4px;    background-color: rgb(9, 111, 0);    border-radius: 2px;    color: #fff;' href='".$final."'>Edit</a></p></div>";
											}
											else 
											{ 
												echo "<div></div>";
		...
		.user-review-rating { background-color: #e3e3d1; width: 190px; padding-left: 5px; float:right; }
			...
			<div class="product-overview" id="product-overview-desktop" style="display:none;">
				...
				<div class="product-share meta clearfix">
					<div class="pp" style="margin-top: 7px;">Do you like this product?</div>
						...
						<td style="padding:0 0 0 5px;">
							...
							<?php } ?>
								...
								<?php if($Product->media) { for($i=0;$i<count($Product->media);$i++) { ?>
									<div>
										<a href="#" onclick="return showThumb(this,'<?php echo $Product->media[$i]->value; ?>');"><img id="thumb-img-<?php echo $i; ?>" src="<?php echo cr_product_image($Product->media[$i]->value,'80x60'); ?>" width="64" height="42" /></a>
									</div>
								<?php } } else { ?>
									<div>
										<img id="thumb-img-0" src="<?php echo cr_product_image($Product->product_image, 'product'); ?>" width="64" height="42" />
									</div>
								<?php } ?>
											...
											<?php 
												...
												$res1=mysqli_fetch_assoc($qry);
													...
													if($_COOKIE['username'])
													{
														...
														{
															echo '<p style="font-size: 14px; padding-top: 10px;"> Own This?<br />Rate It:</p>';
														}
													}
													else
													{
			...
			<div class="item-box">
				<div class="title" id="reviews"><?php echo $Product->product_name; ?></div>
...
<!-- for mobile view -->
					...
					<!-- mobile view start -->
<div class="user-review-mobile" id="user-review-mobile" style="margin-top:10px; width:100%;display:none;border-bottom: 4px solid #e9e8e4;">
   <div style="width:100%;">
      <div style="width:70%; float:left; height: 25px;" class="user-review-header">
...
?></span>
       ...
       <div style="width:30%; float:left;text-align: right;height: 25px;">
 ...
 <div style="width:100%; float:left;">
	 <strong> Year Purchased: </strong><?php if($r->year_purchased==""){echo "  Nill ";}else{ echo $r->year_purchased;} ?>
   </div>
 <div style="width:100%; float:left;">
	 <strong>Purchased:</strong> <?php if($r->product_type==""){echo "  Nill ";}else{ echo $r->product_type;} ?>
   </div>
   <div style="width:100%;float:left;margin-bottom:10px;">
         <strong>Price : </strong> <?php if($r->price==""){echo " Nill ";}else{ echo $r->price;} ?>
   </div>
					...
					<table cellspacing="0" class="user-review-mobile" id="user-review-mobile" style="display:none;border-bottom: 2px solid #e9e8e4;">
						<tr>
							<td width="100%">
								...
								<div class="user-review-similar">
									<?php if(trim($r->similar_products) != '') { ?>
										<strong>Similar Products Used:</strong> <?php echo $r->similar_products; ?>
									<?php } ?>
								</div>				
						...
						<tr>
							<td valign="top" width="100%" align=center>
								<div class="user-review-rating" style="float:none;">
									<table cellspacing="0">
										<tr>
											<td>
												OVERALL<br />RATING
					...
					<table cellspacing="0" class="user-review-desktop" id="user-review-desktop">
						<tr>
							<td width="390">
								<div class="user-review-header">
									<?php echo $r->user_screen_name; ?> &nbsp; 
									<span><?php echo $r->reviewer_experience; ?> [<?php echo $r->date_created; ?>]</span>
								</div>
								<?php if(trim($r->model) != '') { ?>
									<div class="user-review-similar">
